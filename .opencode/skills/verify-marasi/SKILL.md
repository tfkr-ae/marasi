---
name: verify-marasi
description: Verify Marasi's CLI-driven proxy service when a change needs proof through a real launched instance, a proxied HTTP request, persisted traffic inspection, event subscription, launchpad replay, test-case control, finding control, artifact control, Chrome control, waypoint control, wordlist control, Armory template and run control, or extension control.
---
