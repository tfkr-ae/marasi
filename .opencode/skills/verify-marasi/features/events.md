...
- Print listener, project, launchpad, test-case, finding, artifact, Chrome path/profile, waypoint, wordlist, and Armory template/run events from those CLI operations.
