...
- Print listener, project, launchpad, test-case, finding, artifact, Chrome path/profile, waypoint, wordlist, Armory template/run, and extension events from those CLI operations.
